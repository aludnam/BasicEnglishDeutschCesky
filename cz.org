...
| deutsch                         | pa russki     | english                 | \v cesky           |
|---------------------------------+---------------+-------------------------+--------------------|
| kommen                          | ja schass edu | come                    | p\v rij\'\i t      |
| bekommen                        |               | get                     | dostat             |
| geben                           | ja ti biadam  | give, put               | d\'at              |
| gehen                           | ja edu        | go                      | j\'\i t            |
| lassen                          | ja astavlu    | let                     | nechat             |
| machen                          | ja djalaju    | do, make                | d\v elat           |
| scheinen                        |               | seem                    | vypadat            |
| nehmen                          | ja beruk      | take                    | vz\'\i t           |
| sein                            | ja            | be                      | b\'yt              |
| haben                           | minja jest    | have                    | m\'\i t            |
| sagen                           | ja skaju      | say                     | \v r\'\i ct        |
| sehen                           | ja vischu     | see                     | vid\v et           |
| senden                          |               | send                    | poslat             |
| k\"onnen                        |               | can                     | moci               |
...
| jedes                           | sigda (knishka) | everything              | v\v sechno         |
| wenig                           | mala          | little                  | m\'alo             |
| viel                            |               | much                    | hodn\v e           |
| nein                            |               | no                      | ne                 |
| etwas anderes                   |               | another                 | dal\v s\'\i        |
| einiges                         |               | some                    | n\v ejak\'y        |
| solche                          |               | such                    | takov\'y           |
| weil                            | patamuschta   | because                 | proto\v ze         |
| aber                            |               | but                     | ale                |
| oder                            |               | or                      | nebo               |
| hier                            |               | here                    | tade               |
| nah                             |               | near                    | bl\'\i zko         |
...
| Geburtstag                      |               | birthday                | narozeniny         |
| beissen                         |               | to bite                 | kousat             |
| das Blut                        |               | blood                   | krev               |
| der K\"orper                    |               | body                    | t\v elo            |
| der Atem                        |               | breath                  | dech               |
...
| der Schaden                     |               | damage                  | \v skoda              |
| zerst\"oren                     |               | to destroy              | zni\v cit          |
| die Gefahr                      |               | danger                  | nebezpe\v c\'\i       |
...
| treffen                         |               | join (people)           | p\v ridat se        |
...
| die Entwicklung                 |               | development             | v\'yvoj              |
